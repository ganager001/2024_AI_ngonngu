	...
	$('.post-detail').on('click', function () {
		...
		$.ajax({
			...
			success: function (data) {
				...
				$('#articleDesc').text(data.description);
				$('#articleContent').text(data.content);
				$('#articleTarget').text(data.website);
				$('#articleTime').text(data.time);
				$('#articleCommand').text(data.Comments);
				$('#articleLink').text(data.url);
				$('#articleLike').text(data.total_likes);
				$('#articleCommandTotal').text(data.total_comments);
				$('#articleCategory').text(data.category);
			},
...
document.addEventListener('DOMContentLoaded', function () {
	...
	btn.addEventListener('click', function () {
		if (wrapper.classList.contains('show-more')) {
			wrapper.classList.remove('show-more');
