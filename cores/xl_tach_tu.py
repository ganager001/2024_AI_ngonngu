...
class TextProcessor:
    def __init__(self):
        try:
            self.annotator = py_vncorenlp.VnCoreNLP(annotators=["wseg"], save_dir='D:\\5._CODE\\T724_Django\\mainproject\\cores\\core_model')
...
if __name__ == "__main__":
    ...
    processor.process_file('../common/data_input.json', '../common/data_tach_tu.json')